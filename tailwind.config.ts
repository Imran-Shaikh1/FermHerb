    ...
    extend: {
      colors: {
        ...
        "nature": {
          ...
          "background": "hsl(var(--nature-background))",
        },
        "earth": {
          "light": "hsl(var(--earth-light))",
          "medium": "hsl(var(--earth-medium))",
          "dark": "hsl(var(--earth-dark))",
          "background": "hsl(var(--earth-background))",
        },
        "warm": {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow: "0 0 5px hsl(var(--success))",
          },
          "50%": {
            boxShadow: "0 0 20px hsl(var(--success)), 0 0 30px hsl(var(--success))",
          },
        },
      },
      animation: {
        ...
        "celebrate-leaves": "celebrate-leaves 3s ease-in-out infinite",
        "story-slide": "story-slide 0.5s ease-out",
